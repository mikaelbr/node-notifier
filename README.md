# node-notifier [![NPM version][npm-image]][npm-url] [![Build Status][travis-image]][travis-url] [![Dependency Status][depstat-image]][depstat-url] [![Install Size][installsize-image]][installsize-url]
...
[installsize-url]: https://packagephobia.now.sh/result?p=node-notifier
[installsize-image]: https://packagephobia.now.sh/badge?p=node-notifier
